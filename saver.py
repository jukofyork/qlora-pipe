    ...
    def will_save(self, type, name):
        ...
        if type == 'step':
            ...
            if len(self.chrono_states['step']) > self.keep_states:
                ...
                shutil.rmtree(os.path.join(self.save_root, self.chrono_states['step'].pop(0)), ignore_errors=True)
            ...
            if len(self.chrono_states['global_step']) > self.keep_states:
                ...
                shutil.rmtree(os.path.join(self.save_root, self.chrono_states['global_step'].pop(0)), ignore_errors=True)
        else:
